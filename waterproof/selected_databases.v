...
Ltac2 Type WaterproofDatabase := [
    ...
    | WaterproofDecidabilityDBClassical
].
...
Ltac2 load_db_of_label (label: WaterproofDatabase) :=
    ...
    | WaterproofDBRealsAndIntegers =>   (@waterproof_core)::(@zarith)::(@waterproof_integers)::(@arith)::(@real)::(@reals)::[]
    | WaterproofDBSets =>               (@waterproof_core)::(@sets)::[]
    | WaterproofDBSubsets =>            (@waterproof_core)::(@subsets)::[]
    | WaterproofDBAdditional =>         (@additional)::[]
    | WaterproofDBReals =>              (@waterproof_core)::(@real)::(@reals)::[]
    | WaterproofDBClassicalLogic =>     (@waterproof_core)::(@constructive_logic)::(@classical_logic)::[]
    | WaterproofDBConstructiveLogic =>  (@waterproof_core)::(@constructive_logic)::[]
    | WaterproofDBIntegers =>           (@waterproof_core)::(@zarith)::(@waterproof_integers)::(@arith)::[]
