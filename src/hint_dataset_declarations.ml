...
let reals_and_integers: hint_dataset = {
  ...
  decidability_databases: hint_db_name list = ["nocore"; "wp_decidability_nat"; "wp_decidability_integers"; "wp_decidability_reals"; "wp_reals"; "wp_decidability_classical"; "wp_decidability_constructive"];
