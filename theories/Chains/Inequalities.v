...
(* TODO: simplify inequality chain types to allow for below notation
   by default *)
Notation "& x ly" := (total_statement (chain_base x ly%chain)) (at level 70, x at next level, ly at next level) : chain_scope.
