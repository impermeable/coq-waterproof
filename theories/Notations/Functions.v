...
Notation "f 'is' 'injective'" := (injective f) (at level 69) : function_scope.

Notation "f 'is' 'surjective'" := (surjective f) (at level 69) : function_scope.

Notation "f 'is' 'bijective'" := (bijective f) (at level 69) : function_scope.
