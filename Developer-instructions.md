...
opam init
eval $(opam env)
opam install coq-lsp.0.2.0+8.19
opam install ocaml-lsp-server
```
replacing 8.19 with the desired version of Coq, or more generally, replacing
0.2.0+8.19 by the desired version of coq-lsp.
...
opam install ocaml-lsp-server
```
again replacing 8.19 with the desired version of Coq
