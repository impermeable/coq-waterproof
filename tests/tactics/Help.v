...
Goal False.
  ltac2: assert_feedback_with_string (fun () => wp: Help) Info
...
Goal True.
  ltac2: assert_feedback_with_strings (fun () => wp: Help) Info
...
Proof.
  ltac2: assert_feedback_with_strings
  (fun () => wp: It holds that ∀ n > 2, n = n as (i)) Info
...
Proof.
  ltac2: assert_feedback_with_strings
  (fun () => wp: Assume that ∀ n > 3, n = n as (i))
  Info
...
Proof.
  ltac2: assert_feedback_with_strings
  (fun () => wp: We claim that (forall n : nat, n = n) as (i))
  Info
["After proving (∀ n, n = n), consider:";
"Hint, insert: Use ... := ... in ...."].
Abort.
