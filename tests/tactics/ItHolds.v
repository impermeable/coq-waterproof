...
(** Test 22: Test wrapper specialize blocks other tactics  *)
Goal (forall x : nat, x >= 5 -> True) -> True.
Proof.
  intro H1.
  Use x := 6 in (H1).
...
(** Test 23: Test wrapper specialize fails with wrong statement *)
Goal (forall x : nat, x >= 5 -> True) -> True.
Proof.
  intro H1.
...
(** Test 24: Test succesful renaming hypothesis from specialize 
...
(** Test 25: Test fail renaming hypothesis from specialize 
...
(** Test 26: Test fail renaming hypothesis from specialize 
