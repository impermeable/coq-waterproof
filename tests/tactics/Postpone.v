...
Goal (0 = 0).
Proof.
  ltac2: assert_feedback_with_string (fun () => wp: By magic it holds that (False) as (H2)) Warning
"Please come back later to provide an actual proof of False.".
  ltac2: assert_feedback_with_string (fun () => wp: By magic it holds that 0 = 1 as (H3)) Warning
